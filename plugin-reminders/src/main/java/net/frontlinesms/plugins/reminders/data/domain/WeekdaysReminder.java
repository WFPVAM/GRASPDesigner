...
public class WeekdaysReminder extends Reminder {
	...
	public WeekdaysReminder(long startdate, long enddate, Type type, String recipients, String subject, String content) {
	...
	private static final int[] WEEKDAYS = new int[] {Calendar.MONDAY, Calendar.TUESDAY, Calendar.WEDNESDAY, Calendar.THURSDAY, Calendar.FRIDAY};
}