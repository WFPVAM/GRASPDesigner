...
public class Event {
	...
	public static final int TYPE_HTTP_TEST = 11;
	public static final int TYPE_HTTP_RESPONSE = 12;
	public static final int TYPE_HTTP_TEST_OK = 13;
	public static final int TYPE_HTTP_TEST_ERROR = 14;
	public static final int TYPE_HTTP_RESPONSE_OK = 15;
	public static final int TYPE_HTTP_RESPONSE_ERROR = 16;
