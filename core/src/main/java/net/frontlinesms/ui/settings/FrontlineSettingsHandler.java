...
import net.frontlinesms.ui.handler.settings.SettingsWebServerSectionHandler;
	...
	private void loadCoreSettings() {
		...
		this.loadCoreSection(coreTree, new SettingsServicesSectionHandler(this.uiController));
                ...
                /** Web server 
                 ...
                 Mureed 14-8-2014
                 **/
                this.loadCoreSection(coreTree, new SettingsWebServerSectionHandler(this.uiController));
	}
