...
public class SettingsGeneralSectionHandler extends BaseSectionHandler implements UiSettingsSectionHandler, ThinletUiEventHandler {
	...
	public Object getSectionNode() {
		...
		/*Fabaris_Raji  Added to database transfer
		SettingsDatabaseTransferSectionHandler databaseTransferHandler = new SettingsDatabaseTransferSectionHandler(uiController);
		uiController.add(generalRootNode, databaseTransferHandler.getSectionNode());*/
