...
//> GENERATED METHODS
	...
	/**Fabaris_a.zanchi
	 * This method unzip and decodes the text content stream of the message
	 * @throws IOException 
	 * 
	 */
	public void unzipDecodeTextContent() throws Exception {
		
		//byte[] decodedString = Base64Utils.decode(textMessageContent);
		BASE64Decoder decoder = new BASE64Decoder();
		byte[] decodedString = decoder.decodeBuffer(textMessageContent);
		...
		zipInStream.close();
		inStream.close();
		this.textMessageContent = outStream.toString("UTF-8");
	}
}
